...
\begin{enumerate}
    ...
    \item \textbf{Definizione di Metriche Quantitative}: introdurre parametri in grado di misurare di quanto un prompt strutturato riesca a deviare le traiettorie del modello rispetto a una semplice query \textit{zero-shot}.
\end{enumerate}
