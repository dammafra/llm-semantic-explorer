...
Per tali ragioni matematiche e operative, la pipeline illustrata nel prossimo capitolo impiega UMAP come motore esclusivo per la proiezione tridimensionale degli \textit{hidden states} dell'ultimo layer.
