...
\begin{itemize}
    \item Le \textbf{coordinate spaziali} $(x, y, z)$ calcolate tramite UMAP vengono utilizzate per posizionare i nodi nel canvas 3D. Ogni nodo rappresenta il \textit{last hidden state} di un singolo token testuale generato.
